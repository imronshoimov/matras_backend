...
router.post("/products/:id", fileUpload.array("images", 12), validateProducts, insertData);
router.put("/products/:id", fileUpload.array("images", 12), validateProducts, updateData);
